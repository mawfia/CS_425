...
int main( int argc, const char* argv[] ) {
    ...
    auto SetupCallback = [](Engine& engine) { 
        ...
        engine.graphics.loadImage("missileChase", "assets/images/Missile.png");
       ...
       // engine.ECS.Create(Sprite("cheese", 0.1, 0, .5, .5, 1), Position(), Script({ "assets/scripts/cheese.lua" }));
        ...
        engine.ECS.Create(Sprite("missileChase", 0.03, 0, -0.7, 0.6, -1), Script("assets/scripts/missile_chase.lua"));
